...
$yourWebsite = "PSL Paving Nottingham"; // the name of your website
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if ($error_msg == NULL && $points <= $maxPoints) {
		$subject = "Enquiry from PSL Website";
		
		$message = "You received this e-mail enquiry through your website: \n\n";
...
if ($error_msg != NULL) {
	 header('location:#');                         //echo '<p class="error">ERROR: '. nl2br($error_msg) . "</p>";
}
if ($result != NULL) {
	     header('#');                                    //echo '<p class="success">'. $result .;
}
?>
